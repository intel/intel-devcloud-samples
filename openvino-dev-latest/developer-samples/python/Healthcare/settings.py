...
DATA_PATH = os.path.join("/data/Healthcare_app/data/144x144/")
DATA_FILENAME = "Task01_BrainTumour.h5"
OUT_PATH = os.path.join("/data/Healthcare_app/output/")
...
"""
#BATCH_SIZE = 128
#ak-changing to  16 as 128 errors due to RAM size issue on iot dev cloud
BATCH_SIZE = 16
