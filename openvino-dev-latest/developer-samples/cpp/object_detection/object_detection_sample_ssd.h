...
///@brief message for output directory messages
static const char output_dir[] = "Print the output directory location.";
...
/// @brief Define path to output directory
DEFINE_string(o, "", output_dir);
...
static void showUsage() {
    ...
    std::cout << "    -o \"<path>\"             " << output_dir << std::endl;
}
