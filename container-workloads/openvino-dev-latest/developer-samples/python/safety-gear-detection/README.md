...
```
buildah bud --format docker -f ./developer-samples/python/safety-gear-detection/dockerfile/ubuntu20/openvino_cgvh_dev_2023.2.0.dockerfile -t $REGISTRY_URL/safety-gear-detection:custom .
```
...
```
docker build -f ./developer-samples/python/safety-gear-detection/dockerfile/ubuntu20/openvino_cgvh_dev_2023.2.0.dockerfile -t safety-gear-detection:custom .
```
