...
| [Yolo-V8](container-workloads/openvino-dev-latest/developer-samples/python/yolo-v8/README.md) | Convert a pre-trained DarkNet YOLO V8 model to TensorFLow, then run accelerated inference using OpenVINO™ for object detection. Learn how to fine-tune an application for optimal performance. |
