...
COPY benchmark_python/main.py ${INTEL_OPENVINO_DIR}/python/python3.7/openvino/tools/benchmark/main.py
COPY benchmark_python/main.py ${INTEL_OPENVINO_DIR}/python/python3.6/openvino/tools/benchmark/main.py
COPY benchmark_python/main.py ${INTEL_OPENVINO_DIR}/python/python3.6/openvino/tools/benchmark/main.py
...
COPY benchmark_python/dockerfile/ubuntu18/config.txt ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/config.txt
