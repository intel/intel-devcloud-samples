...
RUN mkdir -p  ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/data
RUN mkdir -p  ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/data/output_benchmark/IR/FP32
RUN mkdir -p  ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/data/output_benchmark/IR/FP16
RUN mkdir -p  ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/data/output_benchmark/results/IR32
RUN mkdir -p  ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/data/output_benchmark/results/IR16
RUN mkdir -p  ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/data/models
RUN groupadd intel
...
RUN chown -R  intel:intel  ${INTEL_OPENVINO_DIR} ${INTEL_OPENVINO_DIR}/python  ${INTEL_OPENVINO_DIR}/python/samples ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/data
#RUN mkdir -p  ${INTEL_OPENVINO_DIR}/python/samples

ADD benchmark_python ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python
#RUN mkdir -p  ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/data
ADD benchmark_python/benchmark ${INTEL_OPENVINO_DIR}/python/python3.7/openvino/tools/benchmark
ADD benchmark_python/benchmark ${INTEL_OPENVINO_DIR}/python/python3.6/openvino/tools/benchmark
COPY benchmark_python/benchmark/main.py ${INTEL_OPENVINO_DIR}/python/python3.7/openvino/tools/benchmark/main.py
COPY benchmark_python/benchmark/main.py ${INTEL_OPENVINO_DIR}/python/python3.6/openvino/tools/benchmark/main.py
COPY benchmark_python/benchmark/main.py ${INTEL_OPENVINO_DIR}/python/python3.6/openvino/tools/benchmark/main.py
COPY benchmark_python/benchmark.sh ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python
RUN chown -R  intel:intel  ${INTEL_OPENVINO_DIR} ${INTEL_OPENVINO_DIR}/python  ${INTEL_OPENVINO_DIR}/python/samples  ${INTEL_OPENVINO_DIR}/deployment_tools ${INTEL_OPENVINO_DIR}/deployment_tools/model_optimizer ${INTEL_OPENVINO_DIR}/deployment_tools/model_optimizer/install_prerequisites  /var/lib/dpkg ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/data
...
COPY benchmark_python/dockerfiles/ubuntu18/config.txt ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/config.txt
...
ENTRYPOINT  /bin/bash -c "source ${INTEL_OPENVINO_DIR}/python/samples/benchmark_python/benchmark.sh config.txt"
