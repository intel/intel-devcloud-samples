...
ENTRYPOINT  ${INTEL_OPENVINO_DIR}/python/samples/object-detection-python/run_object_detection.sh
#ENTRYPOINT  ${INTEL_OPENVINO_DIR}/python/samples/object-detection-python/run_benchmark.sh
# Setup jupyterhub
