...
RUN mkdir /classification-ovtf/data
...
#RUN pip3 install https://github.com/openvinotoolkit/openvino_tensorflow/releases/download/v2.0.0/tensorflow_abi1-2.8.0-cp38-cp38-manylinux_2_12_x86_64.manylinux2010_x86_64.whl
#RUN pip3 install ./data/openvino_tensorflow-2.0.0-cp38-cp38-manylinux_2_17_x86_64.manylinux2014_x86_64.whl matplotlib tensorflow-hub scipy pillow
