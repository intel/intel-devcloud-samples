...
python3 object_detection_sample_video_image.py -m $MODEL -i $INPUT_LAYER -o $OUTPUT_LAYER -ip $INPUT_FILE -l $LABELS -it $INPUT_TYPE -d $DEVICE -f $FLAG -ih $INPUT_HEIGHT -iw $INPUT_WIDTH -of $OUTPUT_FILENAMES --output_dir $OUTPUT_DIRECTORY
