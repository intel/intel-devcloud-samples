...
def infer(model, sentences, inputs, pytorch_only):
    ...
    if pytorch_only:
        ...
        f.write("Stock Pytorch\n")
    else:
        f = open(result_file_name, "w")
        f.write("OpenVINO integration with Torch-ORT\n")
    f.write('Throughput: {:.3g} SPS \n'.format(1/(total_infer_time/num_sentences)))
    f.close()
...
def main():
    ...
    # 5. Infer
    infer(model, sentences, inputs, args.pytorch_only)
